<div class="container" id="menu_container">
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a href="?content=home.php" id="homeButton" class="navbar-brand"><span
                    class="glyphicon glyphicon-home"></span> Jabalbina</a>
        </div>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#"><span
                            class="glyphicon glyphicon-list"></span> Newsletters<b class="caret"></b></a>
            ...
            <ul class="nav navbar-nav">
                <li><a href="?content=publications.php"><span
                            class="glyphicon glyphicon-bookmark"></span> Publications</a></li>
            </ul>
            <ul class="nav navbar-nav">
